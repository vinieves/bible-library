...
@section('content')
    <div class="mx-auto max-w-md px-4 py-12">
        ...
        <form method="POST" action="{{ route('password.store') }}" class="space-y-5 rounded-2xl border border-gold/20 bg-brown-deep p-6">
            @csrf
            <input type="hidden" name="token" value="{{ $request->route('token') }}">

            <div>
                <label for="email" class="mb-2 block text-lg text-cream">Correo electrónico</label>
            ...
            <div>
                <label for="password" class="mb-2 block text-lg text-cream">Nueva contraseña</label>
            ...
            <div>
                <label for="password_confirmation" class="mb-2 block text-lg text-cream">Confirmar contraseña</label>
