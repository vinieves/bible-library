<div class="mm-rules">
    @forelse ($rules as $rule)
        @php
            /** @var \App\Models\EmailMessageTemplate $rule */
            $event = $rule->event;
            $preview = \Illuminate\Support\Str::limit(preg_replace('/\s+/', ' ', trim($rule->body)), 90);
        @endphp

        <div wire:key="email-rule-{{ $event->value }}" class="mm-rule-card fi-section">
            <div class="fi-section-content-ctn">
                <div class="mm-rule-card__inner fi-section-content">
                    <div class="mm-rule-card__main">
                        ...
                        @if (filled($rule->subject))
                            <p class="mm-rule-card__subject">
                    ...
                    <div class="mm-rule-card__controls">
                        ...
                        <x-filament::icon-button
                            ...
                            wire:confirm="Excluir esta regra de e-mail?"
                        />
                    </div>
                </div>
            </div>
                ...
                <div class="mm-rules-empty__inner fi-section-content">
                    ...
                    <div>
                        <p class="mm-rules-empty__title">
                            Nenhuma regra de e-mail criada
                        </p>
                        <p class="mm-rules-empty__text">
                            Crie uma regra escolhendo o status da venda Hotmart e definindo assunto e corpo em espanhol.
                        </p>
                    </div>
