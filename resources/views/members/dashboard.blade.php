...
@section('content')
    ...
    <section>
        <p class="mb-3 text-xs font-medium uppercase tracking-wider text-bible-cream/40">Comience donde lo dejó</p>
        ...
        @else
            <div class="dashboard-continue-empty rounded-2xl px-4 py-5 text-center sm:px-6">
                <p class="text-sm text-bible-cream/70">
                    ...
                    <span class="font-medium text-bible-gold">{{ $suggestedStartLabel }}</span>.
                </p>
