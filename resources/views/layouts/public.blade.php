...
<head>
    ...
    <link href="https://fonts.bunny.net/css?family=figtree:400,500,600,700|playfair-display:600,700,800&display=swap" rel="stylesheet">
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
<body class="public-shell font-sans text-bible-cream antialiased">
    @unless($hideHeader ?? false)
        <header class="sticky top-0 z-50 border-b border-bible-gold/10 bg-bible-dark/90 backdrop-blur-md">
            <div class="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
                <a href="{{ route('home') }}" class="flex items-center gap-3 transition hover:opacity-90">
                    ...
                    <span class="font-serif text-lg font-bold text-bible-gold sm:text-xl">
    ...
    @unless($hideFooter ?? false)
        <footer class="border-t border-bible-gold/10 bg-bible-dark/80 py-10 backdrop-blur-sm">
            <div class="mx-auto max-w-6xl px-4 sm:px-6">
                <div class="flex flex-col items-center gap-6 text-center">
                    ...
                    <p class="max-w-md text-sm text-bible-cream/60 sm:text-base">
