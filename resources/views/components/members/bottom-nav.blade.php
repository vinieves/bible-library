@php
    $items = [
        ...
        ['route' => 'members.bonuses', 'label' => 'Bonos', 'icon' => 'M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7'],
...
<nav class="fixed bottom-0 left-0 right-0 z-50 border-t border-bible-gold/20 bg-bible-dark md:hidden">
    <div class="mx-auto flex max-w-3xl justify-around px-2 py-2">
        @foreach($items as $item)
            @php
                $isActive = $item['route'] === 'members.audio.index'
                    ? request()->routeIs('members.audio.*')
