   ...
   class="member-card block overflow-hidden p-0 {{ ! $hasAccess ? 'opacity-80' : '' }}">
    <div class="flex items-stretch">
        ...
        <div class="relative aspect-square w-28 shrink-0 overflow-hidden bg-bible-green/10 sm:w-32">
            ...
            @endif
            @if($percent >= 100)
                <span class="absolute bottom-1 right-1 rounded-full bg-bible-green/90 p-1 text-white">
        ...
        <div class="flex min-w-0 flex-1 flex-col justify-center px-4 py-3.5 sm:px-5 sm:py-4">
            ...
            <div class="mt-2 flex flex-wrap gap-1.5">
                ...
                @elseif($material->hasPdf())
                    <span class="rounded-full bg-bible-green/30 px-2.5 py-0.5 text-xs text-green-300">PDF</span>
                @endif
            </div>
